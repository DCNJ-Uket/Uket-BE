...
import com.uket.modules.redis.constants.RedisValues;
...
public class RotateTokenService {
    ...
    public void storeToken(String refreshToken, String accessToken, Long userId) {
        ...
        tokenDetails.put(RedisValues.REDIS_KEY_ACCESS_TOKEN, accessToken);
        tokenDetails.put(RedisValues.REDIS_KEY_USER_ID, userId.toString());
